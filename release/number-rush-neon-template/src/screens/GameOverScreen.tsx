...
import { TEMPLATE_FEATURES } from '../config/templateFeatures';
...
import { recordCompletedRun } from '../storage/templateStatsStorage';
import { colors, fontFamilies, neonGlow, radii, spacing, withAlpha } from '../theme';

/** Sellable template ships without a shop/economy — hide the coin/gem reward card. */
const SHOW_ECONOMY_REWARD = TEMPLATE_FEATURES.shop || TEMPLATE_FEATURES.missions;
...
export function GameOverScreen({ navigation, route }: Props) {
  ...
  const stats = [
    ...
    { label: 'PERFECT CLEARS', value: String(perfectClears), color: colors.green },

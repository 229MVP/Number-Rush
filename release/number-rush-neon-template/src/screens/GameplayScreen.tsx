...
import { ADVANCED_POWER_UPS_ENABLED } from '../config/templateFeatures';
...
export function GameplayScreen({ navigation, route }: Props) {
  ...
  return (
    ...
    >
      ...
      <PowerUpTray
        visible={ADVANCED_POWER_UPS_ENABLED && trayOpen}
      ...
      <WildValuePicker
        visible={ADVANCED_POWER_UPS_ENABLED && wildPickerOpen}
